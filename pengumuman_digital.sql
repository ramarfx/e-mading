...
--
-- Host: localhost:3306
-- Generation Time: Dec 17, 2023 at 02:18 PM
...
(5, '2023_12_11_064649_create_posts_table', 1),
(6, '2023_12_12_140236_create_roles_table', 1),
(7, '2023_12_12_140453_create_role_user_table', 1),
(8, '2023_12_14_093024_create_bookmarks_table', 1),
(9, '2023_12_15_160759_create_post_views_table', 1);
...
CREATE TABLE `posts` (
  ...
  `category` enum('pengumuman','event','artikel','ekstrakulikuler') NOT NULL,
  `priority_level` enum('biasa','penting') NOT NULL,
  `media_type` varchar(255) NOT NULL DEFAULT 'placeholder',
  `media_path` varchar(255) NOT NULL DEFAULT 'placeholder',
...
--
ALTER TABLE `bookmarks`
  ADD CONSTRAINT `bookmarks_post_id_foreign` FOREIGN KEY (`post_id`) REFERENCES `posts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
